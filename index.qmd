...
When developing resources, you use `main` branch. However, for Github Actions to work, you need an additional branch `gh-pages`. 

hen create a github pages branch
